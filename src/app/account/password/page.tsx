...
export default function AccountPasswordPage() {
  ...
  return (
    <div className="max-w-xl mx-auto px-4 py-10">
      ...
      {message && (
        <div className={`mb-6 px-4 py-3 rounded-xl flex gap-3 text-sm border ${
          message.type === 'ok' ? 'bg-green-50 border-green-200 text-green-800' : 'bg-red-50 border-red-200 text-red-700'
        }`}>
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 space-y-6">
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-2.5 border border-gray-300 rounded-xl shadow-sm focus:ring-primary focus:border-primary text-sm transition-colors"
            placeholder="••••••••"
          />
        </div>
